...
Movie.create!([
      ...
      once more in order to undo Thanos' actions and restore order to the universe.
                ...
                },
                {
                  ...
                  description:
                               %(
      Carol Danvers becomes one of the universe's most powerful heroes when
      ...
      the powerful Thanos before his blitz of devastation and ruin puts an end to the universe.
                ...
                },
                {
                  ...
                  description:
                               %(
      Reckless test pilot Hal Jordan is granted an alien ring that bestows him with otherworldly
      powers that inducts him into an intergalactic police force, the Green Lantern Corps.
    ).squish,
      ...
      Despite her artistic ability she has a more than respectable career as a graphic designer.
                ...
                },
                {
                  ...
                  description:
                               %(
      When a pilot crashes and tells of conflict in the outside world, Diana,
      an Amazonian warrior in training, leaves home to fight a war, discovering
...
# Favorite Movies Seeds
3.times { Favorite.create!(movie_id: rand(1..12), user_id: 1) }

# Reviews and Characterizations Seeds
(1..12).each do |i|
